      ...
      <div className="max-md:hidden">
        <Container className="h-32">
          <div className="flex items-center justify-between h-full gap-28">
            ...
            <div className="flex items-center justify-around px-10 grow gap-2.5 h-full ">
              <Link
                href={"#howItWorks"}
        ...
        <Image
          ...
          width={1362}
          height={296}
          className="absolute hidden md:block  md:top-[-65px] md:right-[-220px] lg:top-[-105px] lg:right-[-260px] xl:top-[-155px] xl:right-[-210px] 2xl:top-[-55px] 2xl:right-[40px] z-[-1]"
        />
      </div>
      <MobileHeader />
    </header>
