...
const TestComponent = () => {
  return (
    <div className="p-8 bg-background">
      <h1 className="text-3xl mb-4">This is a Rubik Heading</h1>
      <p className="mb-4">This is Inter body text in the custom text color.</p>

      <div className="space-y-4">
        <h2 className="text-2xl">Color Examples</h2>
      ...
      <div className="mt-8 space-y-4">
        <h2 className="text-2xl">Button Examples</h2>
