...
const ExampleApiComponent: React.FC = () => {
  ...
  // Create todo example
  const createTodoMutation = usePostData("/todos", {
  ...
  const updateTodoMutation = usePutData("/todos", {
    invalidateQueries: [["todos"]],
  });

  // Patch todo example
  const patchTodoMutation = useUpdateData("/todos", {
    invalidateQueries: [["todos"]],
  });

  // Delete todo example
  const deleteTodoMutation = useDeleteData("/todos", {
    invalidateQueries: [["todos"]],
  });
