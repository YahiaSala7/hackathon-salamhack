...
function PhaseFive({
  ...
  const handleDownload = async () => {
    ...
    const element = reportContainer.querySelector("#report-content");
    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex justify-center gap-4 mt-8">
          <Button
            size="lg"
            className="bg-blue-500 hover:bg-blue-600 text-white flex items-center gap-2 px-8 py-3 rounded-md"
          ...
          <Button
            size="lg"
            variant="secondary"
            className="bg-[#0A0F1C] hover:bg-[#1A1F2C] text-white flex items-center gap-2 px-8 py-3 rounded-md"
            onClick={handleShare}>
