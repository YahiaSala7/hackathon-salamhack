      ...
      const docDefinition = {
        content: [
                ...
                columns: [
                  {
                    ...
                    text: [
                      ...
                      `\nLiving Rooms: ${formData.livingRoom}`,
                      `\nKitchens: ${formData.kitchen}`,
                      formData.otherRooms
                        ? `\nOther Rooms: ${formData.otherRooms}`
                        : "",
                    ],
                  },
                ],
          ...
          products && products.length > 0
            ...
            : null,
        ].filter(Boolean), // Remove null values from content array
        styles: {
          header: {
            fontSize: 24,
            bold: true,
