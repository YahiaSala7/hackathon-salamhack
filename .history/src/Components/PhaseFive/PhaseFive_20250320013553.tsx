...
function PhaseFive({
  ...
  return (
    <div className="px-4 min-h-screen py-6 m-auto flex flex-col">
      <h1 className="text-left text-4xl font-bold text-gray-900 mb-12 ">
      ...
      <div className="flex flex-col flex-1  h-full items-center justify-center">
        ...
        <div className="flex justify-center flex-col md:flex-row gap-4 mt-8">
          <button
            className="bg-blue-500 hover:bg-blue-600 text-white flex items-center gap-2 px-10 py-4 rounded-md"
            onClick={handleDownload}>
            <Download className="w-5 h-5" />
            Download Your Report
          </button>
          <button
            className="bg-[#0A0F1C] hover:bg-[#1A1F2C] text-white flex items-center gap-2 px-10 py-4 rounded-md"
            onClick={handleShare}>
