      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
        {roomCategories.map((room) => (
          <button
            ...
            disabled={isPending}
            className={`w-full lg:text-lg md:text-md text-sm font-semibold text-white flex justify-center items-center gap-2 px-5 py-3 rounded-md cursor-pointer bg-heading hover:bg-[#1A1F2C] 
             `}>
            {room}
          </button>
        ))}
