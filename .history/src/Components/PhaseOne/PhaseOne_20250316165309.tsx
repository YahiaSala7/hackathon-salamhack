...
>(({ error, ...props }, ref) => (
  <input
    ref={ref}
    {...props}
    className={`w-full p-3 bg-gray-50 rounded-[4px] focus:outline-none ${
      error ? "text-red-600 placeholder-red-400" : "placeholder:text-gray-400"
    }`}
...
function PhaseOne() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="px-4 py-6 mx-auto max-w-7xl mb-8">
