...
const CustomSelect = ({
  ...
  return (
    <div className={`relative ${className}`}>
      <div
        className="flex items-center justify-between w-full p-2 bg-white border border-gray-200 rounded-[4px] cursor-pointer"
...
>((props, ref) => (
  <input
    ref={ref}
    {...props}
    className="w-full p-2 bg-white border border-gray-200 rounded-[4px] focus:outline-none focus:border-gray-300"
  />
));
...
const CombinedField = ({
  ...
  <div className="relative flex">
    ...
    <InputField
      {...inputProps}
      className="flex-1 rounded-l-none border-l border-gray-200"
    />
  </div>
);
        ...
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-2">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <button
              ...
              className="w-full p-3 mt-2 text-white bg-[#4F7EF7] rounded-[4px] font-medium hover:bg-blue-600 disabled:bg-blue-300 disabled:cursor-not-allowed transition-colors">
