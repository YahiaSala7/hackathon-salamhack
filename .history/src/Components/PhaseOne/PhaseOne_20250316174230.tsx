        ...
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-2">
          ...
          <form
            ...
            <button
              type="submit"
              disabled={isPending}
              className="w-full p-4 mt-2 text-4xl text-white bg-button rounded-[10px] font-bold hover:bg-button/90 disabled:bg-button/50 disabled:cursor-not-allowed transition-colors shadow-[0_4px_10px_rgba(56,120,255,0.3)]">
              {isPending ? (
