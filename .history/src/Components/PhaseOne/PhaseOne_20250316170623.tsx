...
const CustomSelect = ({
  ...
  return (
    <div className={`relative ${className}`}>
      <div
        className={`flex items-center justify-between w-full p-3 rounded-[4px] cursor-pointer ${
...
>(({ error, ...props }, ref) => (
  <input
    ref={ref}
    {...props}
    className={`w-full p-3 bg-background rounded-[4px] focus:outline-none ${
        ...
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-2">
          ...
          <form
            ...
            <button
              type="submit"
              disabled={isPending}
              className="w-full p-3 mt-2 text-white bg-button rounded-[4px] font-medium hover:bg-button/90 disabled:bg-button/50 disabled:cursor-not-allowed transition-colors shadow-[0_4px_10px_rgba(56,120,255,0.3)]">
              {isPending ? (
