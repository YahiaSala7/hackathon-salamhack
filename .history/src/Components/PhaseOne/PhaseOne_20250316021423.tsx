...
const CustomSelect = ({
  ...
  return (
    <div className={`relative ${className}`}>
      <div
        className="flex items-center justify-between w-full p-3 bg-white rounded-[4px] cursor-pointer"
...
>((props, ref) => (
  <input
    ref={ref}
    {...props}
    className="w-full p-3 bg-white rounded-[4px] focus:outline-none placeholder:text-gray-400"
  />
));
...
const CombinedField = ({
  ...
  <div className="relative flex bg-white rounded-[4px]">
    <div
      className="relative"
      ...
      <div className="px-4 py-6 mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
          ...
          <form
            ...
            className="w-full max-w-xl mx-auto space-y-3 lg:mx-0">
