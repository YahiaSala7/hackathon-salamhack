...
import { submitHomeData } from "@/services/api";
    ...
    <div className="min-h-screen">
      <div className="px-4 py-6 mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-2">
          <div className="text-left lg:text-left sm:text-center space-y-6">
          ...
          <form
            ...
            className="space-y-4 max-w-xl mx-auto lg:mx-0 w-full">
