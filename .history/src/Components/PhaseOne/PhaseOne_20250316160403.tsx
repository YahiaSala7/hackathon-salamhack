...
const formSchema = z.object({
  ...
  location: z
    .string({
      required_error: "Please select your city and country",
    })
    .min(1, "Please select your city and country")
    .refine((val) => val !== "", "Please select your city and country")
    .refine((val) => {
      // Check if the location contains both city and country
    ...
    }, "Please select a specific city and country"),
  ...
  const debouncedSearch = useCallback(
    debounce((query: string) => {
      ...
      fetch(
        ...
        .then((data) => {
          // Filter and format suggestions to show city and country
          const formattedSuggestions = data
            ...
            .map((item: any) => ({
              display_name: `${item.address.city}, ${item.address.country}`,
              lat: item.lat,
              lon: item.lon,
            }));
