...
const formSchema = z.object({
  ...
  location: z
    .string({
      required_error: "Please select your city or governorate",
    })
    .min(1, "Please select your city or governorate")
    .refine((val) => val !== "", "Please select your city or governorate"),
            ...
            <FormField
              ...
              <div className="relative">
                <input
                  ...
                  type="text"
                  placeholder="Enter your city or governorate"
                  className="w-full p-3 bg-gray-50 rounded-[4px] focus:outline-none placeholder:text-gray-400"
                  value={location}
