...
const PhaseOne: FC<PhaseOneProps> = ({ onSubmit, isSubmitting }) => {
    ...
    try {
      ...
      submitHome(data, {
        onSuccess: (response) => {
          ...
          // Store the submission data in localStorage for other phases to access
          if (response.data) {
            ...
            console.log("Stored submission data:", submissionData);
          }
