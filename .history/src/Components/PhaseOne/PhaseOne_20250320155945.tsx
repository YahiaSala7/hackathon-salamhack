...
// Add to your imports
import { type CombinedResponse } from "@/services/combinedApi";

// Update the props interface
interface PhaseOneProps {
  onSubmit: (data: FormData, responseData: CombinedResponse) => void;
      ...
      submitHome(data, {
        onSuccess: (response) => {
          ...
          setTimeout(() => {
            ...
            dispatch({ type: "SET_PROGRESS", payload: 0 });
            // Pass both form data and response data to parent
