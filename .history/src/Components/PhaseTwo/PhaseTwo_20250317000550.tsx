...
import { usePhaseTwoData } from "@/hooks/usePhaseTwoData";
...
const PhaseTwo: FC = () => {
  ...
  const { data, isLoading, isError } = usePhaseTwoData(homeId);
        ...
        (t) => (
          <div className="flex flex-col items-center">
            <p className="text-center mb-2">
              This is preview data. Please fill out your information in Phase
              One to get personalized recommendations.
            </p>
            <button
