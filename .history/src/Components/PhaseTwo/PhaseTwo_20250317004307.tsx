...
const PhaseTwo: FC = () => {
  // In a real app, you would get this from your form state or context
  const formData = null; // This will show placeholder data
  const { data, isLoading, error, isPreviewMode } =
