...
// Sample preview data
const previewData: RecommendationsData = {
  budgetDistribution: [
...
const PhaseTwo: FC = () => {
  ...
  const { data: recommendationsData, isLoading } = useQuery({
    ...
    queryFn: () => recommendationsApi.getRecommendations(homeId!),
    enabled: !!homeId,
  });

  const data = homeId ? recommendationsData?.data : previewData;
              ...
              <div className="flex items-start">
                <div className="ml-3 flex-1">
                  <p className="text-sm font-medium text-gray-900">
                    This is fake data for preview
                  </p>
                  <p className="mt-1 text-sm text-gray-500">
                    Take a look, but you need to fill in your data to get
                    started.
                  </p>
                </div>
              </div>
