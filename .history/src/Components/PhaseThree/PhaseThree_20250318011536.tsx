        ...
        <div
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-600">{item.storeName}</span>
        ...
        <div className="hidden lg:block">
          <div className="inline-flex rounded-lg border border-gray-200 overflow-hidden shadow-sm">
            <button
              ...
              className={`px-4 py-2 text-sm font-medium cursor-pointer transition-all duration-200 ease-in-out ${
                viewMode === "table"
            ...
            <button
              ...
              className={`px-4 py-2 text-sm font-medium border-l cursor-pointer transition-all duration-200 ease-in-out ${
                viewMode === "card"
                  ? "bg-blue-500 text-white"
                  : "bg-white text-gray-700 hover:bg-gray-50"
              }`}>
        ...
        <div className="lg:col-span-3">
          <div className="h-full flex flex-col">
            ...
            <div
              ...
              } hidden lg:flex flex-col bg-white rounded-lg shadow-sm overflow-hidden h-full`}>
            ...
            {/* Card View (Default on small screens, optional on large) */}
            <div
              className={`transition-all duration-300 ease-in-out ${
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-1">
                      <button
                        onClick={() => handlePageChange(currentPage - 1)}
                        disabled={currentPage === 1}
                        className="px-3 py-2 text-gray-500 hover:text-gray-700 disabled:text-gray-300 cursor-pointer">
                        ‹
                      </button>
                      {renderPaginationButtons()}
                      <button
