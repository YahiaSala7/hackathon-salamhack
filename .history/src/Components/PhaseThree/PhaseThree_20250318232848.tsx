...
const PhaseThree: React.FC<PhaseThreeProps> = ({
  ...
  return (
    <div className="min-h-screen p-6">
      ...
      {/* Filter Toggle Button (Visible on small and medium screens) */}
      <div className="lg:hidden fixed bottom-6 right-6 z-50">
        <button
          onClick={() => setIsFilterOpen(!isFilterOpen)}
          className="flex items-center gap-2 px-4 py-3 bg-blue-500 text-white rounded-full shadow-lg hover:bg-blue-600 transition-colors duration-200">
          <svg
            className="w-5 h-5"
            fill="none"
            stroke="currentColor"
