            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs sm:text-sm text-text">USD</span>
                </div>
                <input
                  type="range"
                  min={0}
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs sm:text-sm text-text">km</span>
                </div>
                <input
                  type="range"
                  min={0}
                  ...
                  className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-blue-500"
                />
                <div className="text-xs sm:text-sm text-text text-center">
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="w-full p-2 text-xs sm:text-sm border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition-shadow">
            ...
            <MapContainer
              ...
              {filteredAndSortedProducts.map((product) => (
                <Marker
                  ...
                  <Popup>
                    <div className="p-2">
                      <h3 className="text-xs sm:text-sm font-semibold text-heading mb-2">
                        {product.store.name}
                      </h3>
                      <p className="text-xs sm:text-sm text-text mb-2">
                        {product.title}
                      </p>
                      <p className="text-xs sm:text-sm font-semibold text-heading mb-2">
                        ${product.price}
                      </p>
                      <p className="text-xs sm:text-sm text-text mb-2">
