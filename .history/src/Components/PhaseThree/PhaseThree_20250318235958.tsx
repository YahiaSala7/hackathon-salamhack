            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full h-2 bg-gray-100 rounded-lg appearance-none cursor-pointer accent-blue-500"
                />
                <div className="text-xs sm:text-sm text-text text-center bg-gray-50 px-2 py-1 rounded-full inline-block">
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="w-full p-2 text-xs sm:text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition-all bg-white hover:border-gray-300">
