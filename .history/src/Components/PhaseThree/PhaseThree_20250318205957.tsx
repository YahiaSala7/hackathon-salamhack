    ...
    <div className="min-h-screen p-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-1 flex flex-col space-y-1">
          ...
          {/* Map Section */}
          <div className="bg-white rounded-lg shadow-sm p-4  h-[250px] sm:h-[350px] lg:h-[580px] ">
            <MapContainer
        ...
        <div className="lg:col-span-3">
          ...
          {viewMode === "table" && !isMobile && (
            <div className="bg-white rounded-lg shadow-sm overflow-hidden flex flex-col h-[580px]">
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-gray-50 border-b">
                    <tr>
                      <th className="px-2 py-3 text-left text-sm font-medium text-gray-500 w-[20%]">
                        Title
                      </th>
                      <th className="px-2 py-3 text-center text-sm font-medium text-gray-500 w-[15%]">
                        Category
                      </th>
                      <th className="px-2 py-3 text-center text-sm font-medium text-gray-500 w-[10%]">
                        Image
                      </th>
                      <th className="px-2 py-3 text-center text-sm font-medium text-gray-500 w-[10%]">
                        Price
                    ...
                    {currentItems.map((item) => (
                      <tr key={item.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-2 py-3 text-sm text-center">
                          <a
                            href={item.image.url}
                            className="text-blue-300 hover:text-blue-400 truncate inline-block">
                            View Image
                          </a>
                        </td>
                        ...
                        <td className="px-2 py-3 text-sm text-gray-900 truncate text-center">
                          {item.store.name}
                        </td>
                        <td className="px-2 py-3 text-sm text-center">
                          <a
