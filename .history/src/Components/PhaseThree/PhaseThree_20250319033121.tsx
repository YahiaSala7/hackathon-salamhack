...
const PhaseThree = ({
  ...
  const [filters, setFilters] = useState<FilterState>({
    ...
    rating: 0,
    storeProximity: 10,
    sortBy: "price" as "price" | "rating" | "distance",
  });
  ...
  return (
    <div className="min-h-screen p-6">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="hidden lg:block">
          <div className="inline-flex rounded-lg border border-gray-200 overflow-hidden shadow-sm">
            <button
              ...
              className={`px-3 py-1 rounded-l-md text-xs sm:text-sm ${
                viewMode === "grid"
            ...
            <button
              ...
              className={`px-3 py-1 rounded-r-md text-xs sm:text-sm ${
                viewMode === "table"
                  ? "bg-blue-600 text-white"
                  : "bg-gray-100 text-gray-700 hover:bg-gray-200"
              }`}>
        ...
        {/* View Toggle (Only visible on mobile screens) */}
        <div className="lg:hidden flex justify-center space-x-2 mb-4">
          <button
            onClick={() => setViewMode("grid")}
            className={`px-3 py-1 rounded-l-md text-xs ${
              viewMode === "grid"
                ? "bg-blue-600 text-white"
                : "bg-gray-100 text-gray-700 hover:bg-gray-200"
            }`}>
          ...
          <button
            onClick={() => setViewMode("table")}
            className={`px-3 py-1 rounded-r-md text-xs ${
              viewMode === "table"
                ? "bg-blue-600 text-white"
                : "bg-gray-100 text-gray-700 hover:bg-gray-200"
            }`}>
