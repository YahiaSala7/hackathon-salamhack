              ...
              <div className="overflow-x-auto flex-grow">
                <table className="w-full h-full">
                  <thead className="bg-gray-50 border-b">
                    <tr>
                      <th className="px-2 py-4 text-center text-sm font-medium text-gray-500 w-[20%]">
                        Title
                      </th>
                      <th className="px-2 py-4 text-center text-sm font-medium text-gray-500 w-[15%]">
                        Category
                      </th>
                      <th className="px-2 py-4 text-center text-sm font-medium text-gray-500 w-[10%]">
                        Image
                      </th>
                      <th className="px-2 py-4 text-center text-sm font-medium text-gray-500 w-[10%]">
                        Price
