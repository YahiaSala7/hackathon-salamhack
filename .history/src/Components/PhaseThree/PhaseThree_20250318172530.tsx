...
const PhaseThree: React.FC<PhaseThreeProps> = ({
  ...
  const filteredAndSortedProducts = React.useMemo(() => {
    // Use sample data if form hasn't been submitted
    const dataToFilter = isFormSubmitted ? productsData : SAMPLE_PRODUCTS;
    ...
    return result;
  }, [filters, productsData, isFormSubmitted, defaultCenter]);
                      ...
                      <div className="p-2">
                        ...
                        <div className="flex items-center gap-2">
                          <span className="text-2xl mr-2">
                            {categoryIcons[product.category as Category]}
                          </span>
                        </div>
                      </div>
                    </Popup>
