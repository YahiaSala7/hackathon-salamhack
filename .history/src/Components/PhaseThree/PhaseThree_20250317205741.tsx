        ...
        <div className="lg:col-span-3 h-full">
          <div className="bg-white rounded-lg shadow-sm overflow-hidden h-full flex flex-col">
            <div className="overflow-x-auto flex-grow flex flex-col">
              <table className="w-full h-full table-fixed flex-grow flex flex-col">
                    ...
                    currentItems.map((item, index) => (
                      <tr
                        ...
                        <td className="px-6 py-4 text-sm align-middle">
                          <a
                            href="#"
                            className="text-blue-300 hover:text-blue-400 line-clamp-1">
                            {item.image}
                          </a>
                        </td>
                        <td className="px-6 py-4 text-sm text-gray-900 align-middle">
                        ...
                        <td className="px-6 py-4 text-sm text-gray-900 align-middle">
                          <div className="line-clamp-2">{item.storeName}</div>
                        </td>
                        <td className="px-6 py-4 text-sm align-middle">
                          <a
                            href="#"
                            className="text-blue-300 hover:text-blue-400 line-clamp-2">
                            {item.location}
                          </a>
                        </td>
                        <td className="px-6 py-4 text-sm text-gray-900 align-middle">
