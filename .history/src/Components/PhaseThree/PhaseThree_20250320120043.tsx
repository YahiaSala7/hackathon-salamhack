...
const PhaseThree: React.FC<PhaseThreeProps> = ({
    ...
    if (isFormSubmitted) {
      ...
      if (storedData) {
        try {
          ...
          console.log("Retrieved submission data in PhaseThree:", parsedData);
  ...
  const filteredAndSortedProducts = React.useMemo(() => {
    let result =
      isFormSubmitted && localData ? localData.products : productsData;
    ...
    return result;
  }, [filters, productsData, localData, isFormSubmitted]);
