              ...
              <div className="overflow-x-auto flex-grow">
                <table className="w-full h-full">
                  <thead className="bg-gray-50 border-b">
                    <tr>
                      <th className="px-2 py-4 text-left text-sm font-medium text-gray-500 w-[20%]">
                        Title
                      </th>
                      <th className="px-2 py-4 text-left text-sm font-medium text-gray-500 w-[15%]">
                        Category
                      </th>
                      <th className="px-2 py-4 text-left text-sm font-medium text-gray-500 w-[10%]">
                        Image
                      </th>
                      <th className="px-2 py-4 text-left text-sm font-medium text-gray-500 w-[10%]">
                        Price
                  ...
                  <tbody className="divide-y divide-gray-200">
                    {currentItems.map((item) => (
                      <tr key={item.id} className="hover:bg-gray-50">
                        <td className="2 py-4 text-sm text-gray-900 truncate">
                          {item.title}
                        </td>
                        <td className="2 py-4 text-sm text-gray-900">
                          <div className="flex items-center gap-2">
                            <div
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-1">
                    <button
                      ...
                      className="2 py-2 text-gray-500 hover:text-gray-700 disabled:text-gray-300">
                      ‹
                    </button>
