...
function Planning() {
  ...
  // Effect to check for existing submission data
  useEffect(() => {
    if (submissionData) {
      setIsFormSubmitted(true);
      setHasPassedPhaseOne(true);
  ...
  return (
    <div className="container mx-auto">
      {(isPending || isLoading) && <LoadingOverlay progress={progress} />}
      <div ref={phaseOneRef} id="phase-one">
        <PhaseOne onSubmit={handleFormSubmit} isSubmitting={isPending} />
      </div>
      <PhaseTwo
        formData={formData}
