...
function Planning() {
  ...
  // Fetch unified data for all phases
  const { data: unifiedData, isLoading, error } = useUnifiedData(formData);
  ...
  return (
    <div className="container mx-auto">
      ...
      <PhaseTwo
        ...
        recommendationsData={
          unifiedData || { budgetDistribution: [], recommendations: {} }
        }
        isLoading={isLoading}
        error={error}
      />
      <PhaseThree
        ...
        productsData={unifiedData?.products || []}
        isLoading={isLoading}
        error={error}
      />
    </div>
