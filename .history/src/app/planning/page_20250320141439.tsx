...
function Planning() {
  ...
  const { data: combinedData, isLoading, error } = useCombinedData(formData);
    ...
    (data: FormData) => {
      ...
      submitHome(data, {
        onSuccess: (response) => {
          ...
          // Store form data and update submission state
          setFormData(data);
  ...
  return (
    <div className="container mx-auto">
      ...
      <PhaseTwo
        ...
        recommendationsData={
          isFormSubmitted && combinedData?.data
            ? {
                budgetDistribution: combinedData.data.budgetDistribution,
                recommendations: combinedData.data.recommendations,
              }
      ...
      <PhaseFour
        ...
        recommendations={
          isFormSubmitted && combinedData?.data
            ? combinedData.data.recommendations
      ...
      <PhaseFive
        ...
        budgetDistribution={
          isFormSubmitted && combinedData?.data
            ? combinedData.data.budgetDistribution
